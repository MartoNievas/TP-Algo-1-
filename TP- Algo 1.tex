...
\begin{quote}
	...
	\vspace{0.2cm}
	\\ 
	\pred{mimasCiudades}{\In s: \TLista{Ciudad}, \In l: \TLista{Ciudad}}{\paraTodo[unalinea]{i}{\ent}{0 \leq i < |s| \implicaLuego \existe[unalinea]{j}{\ent}{0 \leq j < |l| \yLuego s[i] = l[j]}} }
	\vspace{0.2cm}
