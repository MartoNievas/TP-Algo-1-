...
Aclaraciones: $f_v$ es la función variante, la cual se define como $f_v = (\longitud{ciudades} - i)$. Dado que $f_v$ debe ser una función decreciente y la longitud de ciudades es constante mientras que $i$ crece con cada iteración, se trata de una función decreciente.

Para ejemplificar, supongamos que la lista de ciudades es ciudades = [("Buenos Aires", 30000), ("Santa Rosa", 15000), ("Rosario", 25000), ("Jujuy", 20000)]. La siguiente tabla muestra una visualización de la evolución de los valores en cada iteración:
...
Primero definamos $\{I \land f_v \leq 0\}$:
$
